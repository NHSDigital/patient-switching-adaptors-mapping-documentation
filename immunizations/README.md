...
| confidentialityCode                               | When `Immunization.meta.security` is present and has a value of `NOPAT`. See [Confidentiality Codes](../confidentiality%20code/README.md) for mapping details. |
...
- [GP Connect Immunization](https://gpc-structured-1-6-0.netlify.app/accessrecord_structured_development_immunization.html)
