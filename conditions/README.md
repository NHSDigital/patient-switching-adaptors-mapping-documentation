...
| meta.security                         | When `LinkSet / confidentialityCode [@code]` or `EhrComposition / confidentialityCode [@code]` is present and has a value of `NOPAT`. See [Confidentiality Codes](../confidentiality%20code/README.md) for mapping details.                                                               |
...
| asserter.reference                    | [Practitioner](../practitioners/README.md) referenced by `ehrComposition / participant2[0] / agentRef / id [@root]` or else `ehrComposition / author / agentRef / id [@root]`                                                                                                             |
...
resource types stated [here](https://gpc-structured-1-6-0.netlify.app/accessrecord_structured_problems.html#extensionactualproblem)
...
resource types stated [here](https://gpc-structured-1-6-0.netlify.app/accessrecord_structured_problems.html#extensionrelatedclinicalcontent)
...
| confidentialityCode                             | When `Condition.meta.security` is present and has a value of `NOPAT`. See [Confidentiality Codes](../confidentiality%20code/README.md) for mapping details.                                                                    |
...
| Participant / agentRef / id [@root]             | the mapped [Practitioner](../practitioners/README.md) referenced by `Conditioner.asserter`                                                                                                                                     |
...
- [Problems guidance](https://gpc-structured-1-6-0.netlify.app/accessrecord_structured_development_problems_guidance.html)
- [GP Connect ProblemHeader (Condition)](https://gpc-structured-1-6-0.netlify.app/accessrecord_structured_problems.html)
