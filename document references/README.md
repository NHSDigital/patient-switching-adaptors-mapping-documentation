...
| meta.security                                  | When `ExternalDocument / confidentialityCode [@code]` is present and has a value of `NOPAT`. See [Confidentiality Codes](../confidentiality%20code/README.md) for mapping details. |
...
| custodian                                      | reference to the losing [Organization](../organizations/README.md)                                                                                                                 |
...
- [GP Connect DocumentReference](https://gpc-structured-1-6-0.netlify.app/access_documents_development_documentreference.html)
