...
A `PractitionerRole` resource will only be added if the HL7 `AgentPerson` has an associated `representedOrganization`.
...
| Agent / code / originalText         | `PractitionerRole.code[0].coding[0].display` <sup>1</sup>                                                            | 
...
| Agent / representedOrganisation     | Mapped using the [Organisation](../organizations/README.md) referenced in `PractitionerRole` (if present) <sup>3</sup> |  
...
- [GP Connect Practitioner structure definition](https://simplifier.net/stu3-fhir-assets/careconnect-gpc-practitioner-1)
- [GP Connect PractitionerRole structure definition](https://simplifier.net/stu3-fhir-assets/careconnect-gpc-practitionerrole-1)
