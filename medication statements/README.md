...
| meta.security                                     | When `MedicationStatement / confidentialityCode [@code]` or `EhrComposition / confidentialityCode [@code]` is present and has a value of `NOPAT`. See [Confidentiality Codes](../confidentiality%20code/README.md) for mapping details. |
...
| basedOn.reference                                 | a reference to a [MedicationRequest](../medication%20requests/README.md) using `ehrSupplyAuthorise / id [@root]` as the reference id                                                                                                    |
...
| extension\[0].valueCodeableConcept.coding.code    | `"prescribed-at-gp-practice"`, `"prescribed-by-another-ogranisation"` or `"prescribed-by-previous-practice"`                                                                                                                            |
| extension\[0].valueCodeableConcept.coding.display | `"Prescribed at GP practice"`, `"Prescribed by another organisation"` or `"Prescribed by previous practice"`                                                                                                                            |
...
| confidentialityCode                                                                      | When `medicationRequest.meta.security` is present and has a value of `NOPAT`. See [Confidentiality Codes](../confidentiality%20code/README.md) for mapping details.                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
- [GP Connect MedicationStatement](https://gpc-structured-1-6-0.netlify.app/accessrecord_structured_development_medicationstatement.html)
