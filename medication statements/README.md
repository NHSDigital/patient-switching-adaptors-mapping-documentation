...
| extension\[0].valueCodeableConcept.coding.code    | different values = `"prescribed-at-gp-practice"` or `"prescribed-by-another-ogranisation"` or `"prescribed-by-previous-practice"`                                                                                                     |
| extension\[0].valueCodeableConcept.coding.display | different values = `"Prescribed at GP practice"` or  `"Prescribed by another organisation"` or `"Prescribed by previous practice"`                                                                                                    |
