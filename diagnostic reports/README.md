...
| meta.security                                | When `CompoundStatement / confidentialityCode [@code]` or `EhrComposition / confidentialityCode [@code]` is present and has a value of `NOPAT`. See [Confidentiality Codes](../confidentiality%20code/README.md) for mapping details.                                                                           |
...
3. Where there is more than one Narrative Statement, the text will be concatenated into one note, separated by newlines.
...
populated. The fields are concatenated and separated by newlines, before being inserted into the `text` element of the 
...
- [GP Connect Diagnostic report documentation](https://gpc-structured-1-6-0.netlify.app/accessrecord_structured_development_DiagnosticReport.html)
- [GP Connect Specimen documentation](https://gpc-structured-1-6-0.netlify.app/accessrecord_structured_development_specimen.html)
