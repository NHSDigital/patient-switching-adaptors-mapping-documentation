...
With the exception of the related field, Test Result observations are mapped identically to [Uncategorised Data](#Uncategorised-Data-(XML-HL7->-JSON-FHIR)). 
...
| component\[index] / NarrativeStatement    | Mapped from `Observation` as outlined in **Narrative statement mapping for [Test Group Header](#Test-Group-Header-(JSON-FHIR->-XML-HL7)) and [Test Result](#Test-Result-(JSON-FHIR->-XML-HL7))** <sup>8</sup> and [Filing comments](#Filing-Comment-(JSON-FHIR->-XML-HL7))  |
...
| component / NarrativeStatement        | Mapped from `Observation` as outlined in **Narrative statement mapping for [Test Group Header](#Test-Group-Header-(JSON-FHIR->-XML-HL7)) and [Test Result](#Test-Result-(JSON-FHIR->-XML-HL7))** <sup>8</sup> and [Filing Comments](#Filing-Comment-(JSON-FHIR->-XML-HL7)) |
