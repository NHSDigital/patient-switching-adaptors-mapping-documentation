...
|------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|
| CompoundStatement / id \[@root]                                              | CompoundStatement ID (UUID) fetched from resource ID or, if not valid UUID, generated by the Adaptor         |
...
| ObservationStatement / id \[@root]                                           | ObservationStatement ID (UUID) fetched from resource ID or, if not valid UUID, generated by the Adaptor      |
