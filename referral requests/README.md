...
| meta.security                                | When `RequestStatement / confidentialityCode [@code]` or `EhrComposition / confidentialityCode [@code]` is present and has a value of `NOPAT`. See [Confidentiality Codes](../confidentiality%20code/README.md) for mapping details. |
...
- [GP Connect ReferralRequest](https://gpc-structured-1-6-0.netlify.app/accessrecord_structured_development_referralrequest.html)
