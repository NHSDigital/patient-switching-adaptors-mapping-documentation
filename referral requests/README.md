...
| note                                         | mapped Annotation from `RequestStatement / text`                                                                                                                                                    |
...
| reference to [Organisation](../organisations/README.md) `RequestStatement / Participant [@typeCode='AGNT'] / agentRef `      | `ReferralRequest.requester.agent.reference` & `ReferralRequest.onBehalfOf`  when agent is `practictioner` and `onBehalfOf' is reference to `Organization`                                                                                                                                                                                                                                                                                                                                                                                                                                  |
